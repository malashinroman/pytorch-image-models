...
for aa in ["rand-m12-mmax20-mstd0.5", "rand-m5-mstd0.5", "rand-m9-mstd0.9", 
           "original-mstd0.5", "v0-mstd0.5", "v0r-mstd0.5", "originalr-mstd0.5", 
           "augmix-m5-w4-d2"]:
    config = {
        "aa": aa,
        "tag": f"{base_tag}_no_geom_aa_{aa}",
    }
...
#         "tag": f"{base_tag}_no_geom_aa_{aa}_grayscale",
#     }
#     configs.append([config, None])
