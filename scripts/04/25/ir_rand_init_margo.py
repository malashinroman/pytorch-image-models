...
from local_config import IR_VIS_DATASET_PATH_MARGO as IR_VIS_DATASET_PATH
...
config = {
    ...
    "no-aug": "parameter_without_value",
    "random_invert_p": 0.5,
    "tag": f"{base_tag}_no_aug_rand_invert_p_0.5",
}
...
config = {
    ...
    "random_invert_p": 0.5,
    "adjust_sharpness": 10,
    "tag": f"{base_tag}_no_aug_rand_invert_p_0.5_adjust_sharpness_10",
}
configs.append([config, None])
