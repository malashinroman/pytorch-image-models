...
config = {
    ...
    "random_invert_p": 0.5,
    "adjust_sharpness": 10,
    "tag": f"{base_tag}_inv_prob_0.5_rand_sharpness",
}
configs.append([config, None])
...
config = {
    ...
    "adjust_sharpness": 10,
    "color-jitter": 0.4,
    "tag": f"{base_tag}_inv_prob_0.5_rand_sharpness_color_jitter",
}
configs.append([config, None])
...
config = {
    ...
    "tag": f"{base_tag}_inv_prob_0.5_rand_sharpness_color_jitter_grayscale",
}
configs.append([config, None])
...
config = {
    ...
    "color-jitter": 0.4,
    "to_grayscale": "parameter_without_value",
    "tag": f"{base_tag}_inv_prob_0.5_rand_sharpness_color_jitter_grayscale_resnet50",
}
configs.append([config, None])
